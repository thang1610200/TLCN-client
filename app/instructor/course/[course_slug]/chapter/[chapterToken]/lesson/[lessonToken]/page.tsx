...
const LessonToken = ({
    ...
    const { data, isLoading, error, mutate } = useLessonDetail(params.course_slug, session.data?.user.email, session.data?.backendTokens.accessToken, params.chapterToken, params.lessonToken);
