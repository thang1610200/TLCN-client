...
import SecondScreenOld from './components/SecondScreenOld';
    ...
    return (
        <div>
            <div className="w-full h-full"> {/*Chua dung lazy animation*/}
                ...
                {/* <div ref={refPage1} className="flex flex-col items-center justify-center w-screen h-screen bg-slate-100">
                    <div className="flex items-center justify-center h-56 max-w-4xl mt-20">
                        <h1 className="p-4 leading-normal text-center font-beauSans-extrabold text-7xl text-slate-950 line-clamp-2 ">Khám phá sức mạnh của kiến thức</h1>
                    </div>
                    <div className="">
                        <h2 className="p-4 text-xl text-center font-beauSans-extrabold text-slate-950 text-balance">Nơi kết nối, học hỏi và phát triển mỗi ngày</h2>
                    </div>
                    <div className="p-4">
                        <Button className='h-16 gap-2 text-xl text-center font-beauSans-extrabold w-80 text-slate-950'>
                            <h6>Khám phá ngay</h6>
                            <ArrowRight />
                        </Button>
                    </div>
