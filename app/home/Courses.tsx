...
export default function Courses() {
  return (
    <div className='flex flex-col items-start mx-8 mb-8 space-y-3 mt-14'>
      ...
      <h3 className='text-xl'>Choose from 183,00 online video courses with new addition published every month</h3>
      ...
      <div className='w-full text-left border border-gray-300 p-7'>
        <h2 className='mb-2 text-2xl font-bold'>Expand your career opportunities with Universe Code</h2>
        <h3>Take one of Udemy’s range of Python courses and learn how to code using this incredibly useful language. Its simple syntax and readability makes Python perfect for Flask, Django, data science, and machine learning. You’ll learn how to build everything from</h3>
