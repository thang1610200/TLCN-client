        ...
        <div className="bg-white dark:bg-gray-900">
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div className="mx-auto max-w-screen-sm text-center">
                    ...
                    <Link href="/" className="hover:text-blue-600 inline-block rounded-lg border border-blue-600 px-8 py-3 text-center text-base font-semibold text-blue-600 transition hover:bg-blue-300">
                        Go To Home
                    </Link> 
                </div>   
            </div>
